...
const BlogSection = () => {
  const { news, loading } = useNews("vidhit");
  const recentBlogs = news.slice(0, 3);
          ...
          {recentBlogs.map((blog) => (
            ...
            >
              ...
              <div className="relative h-56 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4 translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300 z-30">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="mt-auto">
                  <a
                    ...
                    className="flex items-center text-primary font-bold text-sm tracking-wide uppercase group/btn hover:text-accent transition-colors"
                  >
                    Read More
